(function (a) {
    a(document).ready(function () {
        a(window).load(function () {
            ...
            b.async = !0;
            b.src = "https://apis.google.com/js/platform.js?key=AIzaSyA6FLR8gecQm-cIZak8YibN-A72jBcQ-UU";
        ...
        a(window).scroll(function () {
            var b = a(this).scrollTop(), d = a("#top-header"), c = a("#logo-header .logo"), e =
                a(".right-nav-button"), f = d.height() + a(".track-header").height();
            ...
            a(".slot").each(function () {
                var d = a(this).offset().top - b, e = f + a(this).find(".slot-title").height();
        ...
        a(function () {
            a("a[href*=#]:not([href=#])").click(function () {
                if (location.pathname.replace(/^\//, "") == this.pathname.replace(/^\//, "") && location.hostname == this.hostname) {
                    var b = a(this.hash), b = b.length ? b : a("[name=" + this.hash.slice(1) +
                            "]");
        ...
        a(".animated").appear(function () {
            var b = a(this), d = b.data("animation"), c = b.data("delay");
        ...
        a(".slider-next-item").click(function () {
            var b = a(this).closest("div"), d = b.find(".slider-current-item").next();
    ...
    if ("undefined" !== typeof googleMaps) {
        var c, q, n, r, p, h, l = [], x = new google.maps.DirectionsService;
        google.maps.event.addDomListener(window, "load", function () {
            ...
            function v(a) {
                var b = c.getZoom(), d = Math.abs(a - b), e = a > b ? 1 : -1;
            ...
            l.push(t);
            var f = new google.maps.StyledMapType([{stylers: [{lightness: 40}, {visibility: "on"}, {gamma: .9}, {weight: .4}]}, {
                elementType: "labels",
                stylers: [{visibility: "on"}]
            }, {featureType: "water", stylers: [{color: "#5dc7ff"}]}, {
                featureType: "road",
                stylers: [{visibility: "off"}]
            }], {name: "Default Style"}), w = new google.maps.StyledMapType([{stylers: [{lightness: 40}, {visibility: "on"}, {gamma: 1.1}, {weight: .9}]},
