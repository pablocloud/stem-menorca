!function (d) {
    d.fn.appear = function (h, a) {
        ...
        return this.each(function () {
            ...
            var b = d(window), e = function () {
                if (!a.is(":visible"))return void(a.appeared = !1);
                var g = b.scrollLeft(), f = b.scrollTop(), d = a.offset(), e = d.left, d = d.top, h = c.accX, H = c.accY, w = a.height(), I = b.height(), J = a.width(), B = b.width();
    ...
    d.extend(d.fn.appear, {
        checks: [], timeout: null, checkAll: function () {
            ...
            if (0 < h)for (; h--;)d.fn.appear.checks[h]()
        }, run: function () {
...
!function (d) {
    d.fn.countTo = function (h) {
        return h = h || {}, d(this).each(function () {
            ...
            }, h), l = Math.ceil(c.speed / c.refreshInterval), b = (c.to - c.from) / l, e = this, g = d(this), n = 0, f = c.from, t = g.data("countTo") || {};
            g.data("countTo", t);
    ...
    d.fn.countTo.defaults = {
        from: 0, to: 0, speed: 1E3, refreshInterval: 100, decimals: 0, formatter: function (d, a) {
            ...
            if (!a.data("sticky_kit")) {
                ...
                E = function () {
                    ...
                    if (!F && (g = parseInt(q.css("border-top-width"), 10), c = parseInt(q.css("padding-top"), 10), t = parseInt(q.css("padding-bottom"), 10), v = q.offset().top + g + c, k = q.height(), x && (A = x = !1, null == b && (a.insertAfter(r), r.detach()), a.css({
                            ...
                            height: z, display: a.css("display"), "vertical-align": a.css("vertical-align"), "float": y
                        }), d))return m()
                };
                E();
                if (z !== k)return D = void 0, p = e, C = n, m = function () {
                    ...
                    if (!F && (null != C && (--C, 0 >= C && (C = n, E())), m = h.scrollTop(), null != D && (d = m - D), D = m, x ? (c && (u = m + z + p > k + v, A && !u && (A = !1, a.css({
                            ...
                            l && (g = h.height(), z + e > g && !A && (p -= d, p = Math.max(g - z, p), p = Math.min(e, p), x && a.css({top: p + "px"})))) : m > B && (x = !0, g = {
                                position: "fixed",
                                top: p
                            }, g.width = "border-box" === a.css("box-sizing") ? a.outerWidth() + "px" : a.width() + "px", a.css(g).addClass(f), null == b && (a.after(r), "left" !== y && "right" !== y || r.append(a)), a.trigger("sticky_kit:stick")), x && c && (null == u && (u = m + z + p > k + v), !A && u)))return A = !0, "static" === q.css("position") && q.css({position: "relative"}), a.css({
                        position: "absolute",
                        bottom: t,
                        top: "auto"
...
!function (d) {
    ...
    h.prototype = {
        constructor: h, init: function () {
            ...
            this.init()
                                ...
                                c) {
            if (!0 !== this.stop) {
                var d = Math.round(70 * Math.random()) + this.typeSpeed, b = this;
                b.timeout = setTimeout(function () {
                    var d = 0, g = a.substr(c);
                    if ("^" === g.charAt(0)) {
                        var n = 1;
            ...
            if (!0 !== this.stop) {
                var h = Math.round(70 * Math.random()) + this.backSpeed, b = this;
                b.timeout = setTimeout(function () {
                    if ("html" ===
                        b.contentType && ">" === a.substr(d).charAt(0)) {
                        for (var e = ""; "<" !== a.substr(d).charAt(0);)e -= a.substr(d).charAt(0), d--;
                        d--
                    }
                    e = a.substr(0, d);
    ...
    d.fn.typed = function (a) {
        return this.each(function () {
            var c = d(this), l = c.data("typed"), b = "object" == typeof a && a;
...
!function (d) {
    ...
    function a(a) {
        var c;
        if (!1 === e.allowEvent(a)) c = null; else {
            c = null;
    ...
    var c = c || {}, l = document.querySelectorAll.bind(document), b = {
        duration: 750, show: function (a, d) {
            var f, c;
            if (2 === a.button)return !1;
            var e = d || this, k = document.createElement("div");
            ...
            e.touchup(a);
            var d = this, c = (1.4 * d.clientWidth, null);
            a = d.getElementsByClassName("waves-ripple");
            if (!(0 < a.length))return !1;
            var c = a[a.length - 1], l = c.getAttribute("data-x"), v = c.getAttribute("data-y"), k = c.getAttribute("data-scale");
